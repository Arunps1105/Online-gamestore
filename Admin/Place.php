...
<head>
    ...
    <title>GameHub::Place Management</title>
...
<body>
    ...
    <div class="loading-overlay" id="loadingOverlay">
        ...
        <h3 class="mt-4 text-white">Loading Place</h3>
    </div>
    <!-- Sidebar Navigation -->
        ...
        <div class="container-fluid">
            ...
            <div class="row mb-4">
                <div class="col">
                    ...
                    <p class="text-muted">Manage game distribution locations for your platform</p>
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    if($rowCount == 0): ?>
                        <div class="text-center py-5">
                            ...
                            <h4 class="mt-3 text-white">No places found</h4>
                            <p class="text-muted">Add your first place to get started</p>
                        </div>
                    <?php else: ?>
