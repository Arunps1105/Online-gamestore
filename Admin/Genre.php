...
{
    $genre=$_POST["txt_genre"];
    $hid=$_POST["txt_hid"];

    if($hid=="")
    {
        $insqry="insert into tbl_genre(genre_name)value('".$genre."')";
        if($Con->query($insqry))
        {
            ?>
            <script>
    ...
    {
        $upqry="update tbl_genre set genre_name='".$genre."' where genre_id='".$hid."'";
        if($Con->query($upqry))
        {
            ?>
            <script>
...
if(isset($_GET['aid']))
{
    $Delqry="delete from tbl_genre where genre_id='".$_GET['aid']."' ";
    if($Con->query($Delqry))
    {
        ?>
        <script>
...
if(isset($_GET['eid']))
{
    $selqry="select * from tbl_genre where genre_id='".$_GET['eid']."' ";
    $result=$Con->query($selqry);
    $row=$result->fetch_assoc();
    $editname=$row['genre_name'];
    $editid=$row['genre_id'];
}
?>
...
<head>
    ...
    <title>GameHub::Genre Management</title>
...
<body>
    ...
    <div class="loading-overlay" id="loadingOverlay">
        ...
        <h3 class="mt-4 text-white">Loading Genre</h3>
    </div>
    <!-- Sidebar Navigation -->
        ...
        <div class="container-fluid">
            ...
            <div class="row mb-4">
                <div class="col">
                    ...
                    <p class="text-muted">Manage game genres for your platform</p>
                </div>
            </div>
            ...
            <div class="glass-card mb-4 animate_animated animate_fadeInUp">
                <div class="card-header bg-primary text-white border-0">
                    <h3 class="mb-0">
                        <i class="fas fa-<?php echo ($editid ? 'sync-alt' : 'plus-circle') ?> me-2"></i>
                        <?php echo ($editid ? 'Update Genre' : 'Add New Genre') ?>
                    </h3>
                </div>
                <div class="card-body">
                        ...
                        <div class="row g-3">
                            <div class="col-md-8">
                                <div class="form-group">
                                    <label for="txt_genre" class="form-label">Genre Name</label>
                                    <input type="hidden" name="txt_hid" id="txt_hid" value="<?php echo $editid ?>" />
                                    <input type="text" class="form-control form-control-lg" 
                                        name="txt_genre" id="txt_genre" 
                ...
                <div class="card-body">
                    ...
                    if($rowCount == 0): ?>
                        <div class="text-center py-5">
                            ...
                            <h4 class="mt-3 text-white">No genres found</h4>
                            <p class="text-muted">Add your first genre to get started</p>
                        </div>
                    <?php else: ?>
                            ...
                            <table class="table table-hover align-middle">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <a href="Genre.php?eid=<?php echo $row['genre_id'] ?>" 
                                                   class="btn btn-warning btn-sm me-2">
                                                    <i class="fas fa-edit"></i> Edit
                                                </a>
                                                <a href="Genre.php?aid=<?php echo $row['genre_id'] ?>" 
