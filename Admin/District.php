...
if(isset($_GET['eid']))
{
    ...
    $editname=$row['district_name'];
    $editid=$row['district_id'];
}
?>
...
<head>
    ...
    <title>GameHub::District Management</title>
...
<body>
    ...
    <div class="loading-overlay" id="loadingOverlay">
        ...
        <h3 class="mt-4 text-white">Loading District</h3>
    </div>
    <!-- Sidebar Navigation -->
        ...
        <div class="container-fluid">
            ...
            <div class="row mb-4">
                <div class="col">
                    ...
                    <p class="text-muted">Manage game distribution regions for your platform</p>
                </div>
            </div>
            ...
            <div class="glass-card mb-4 animate_animated animate_fadeInUp">
                <div class="card-header bg-primary text-white border-0">
                    <h3 class="mb-0">
                        ...
                        <?php echo ($editid ? 'Update District' : 'Create New District') ?>
                    </h3>
                </div>
                <div class="card-body">
                ...
                <div class="card-body">
                    ...
                    if($rowCount == 0): ?>
                        <div class="text-center py-5">
                            ...
                            <h4 class="mt-3 text-white">No districts found</h4>
                            <p class="text-muted">Add your first district to get started</p>
                        </div>
                    <?php else: ?>
