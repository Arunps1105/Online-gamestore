...
<head>
    ...
    <title>GameStore Pro - Gamer Dashboard</title>
...
<body>
    ...
    <div class="sidebar p-3">
        ...
        <div class="welcome-card p-3 mb-4 text-white animate__animated animate__fadeIn">
            <div class="d-flex align-items-center">
                <div class="flex-grow-1">
                    ...
                    <h4 class="mb-0 fw-bold"><?php echo $_SESSION['uname'] ?></h4>
                </div>
        ...
        <a class="nav-link active animate__animated animate__fadeInLeft" href="Myprofile.php">
            ...
            <span class="nav-text">Gamer Profile</span>
        </a>
    </li>
         <li class="nav-item">
    <a class="nav-link animate__animated animate__fadeInLeft" href="Complaint.php">
        <i class="fas fa-comment-dots "></i> <!-- Red speech bubble -->
        <span class="nav-text">Post Complaint</span>
    </a>
</li>
            <li class="nav-item">
    <a class="nav-link animate__animated animate__fadeInLeft" href="feedback.php">
        <i class="fas fa-comment-medical"></i> <!-- Feedback icon -->
        <span class="nav-text">Give Feedback</span>
            ...
            <li class="nav-item">
                <a class="nav-link animate__animated animate__fadeInLeft  " href="Communitys.php">
                    ...
                    <span class="nav-text">Join Community</span>
                </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link animate__animated animate__fadeInLeft  " href="Viewgame.php">
                    ...
                    <span class="nav-text">Browse Games</span>
                </a>
            </li>
        
         <li class="nav-item">
                <a class="nav-link animate__animated animate__fadeInLeft  " href="MyLibrary.php">
                <i class="fas fa-dice-d20"></i> 
                    <span class="nav-text">My Library</span>
                </a>
            </li>
        </ul>
        
        <div class="position-absolute bottom-0 start-0 p-3 w-100">
            <a href="Logout.php" class="btn logout-btn d-block text-center animate__animated animate__fadeInUp ">
    ...
    <div class="main-content">
        <div class="container-fluid">
            <div class="row mb-4">
                <div class="col">
                    <h2 class="fw-bold text-white mb-2">Gamer Dashboard</h2>
                    <p class="text-muted opacity-75">Your personal gaming hub</p>
                </div>
            </div>
            
            <!-- Gamer Stats -->
            <div class="gamer-stats glass-card animate__animated animate__fadeIn">
                <div class="row">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="dashboard-card p-4 text-center animate__animated animate__fadeIn   glass-card">
                        <i class="fas fa-comment-exclamation card-icon"></i>
                        <h5 class="mb-3">Complaints</h5>
                        <p class="text-muted mb-3">Submit your complaints</p>
                        <a href="Complaint.php" class="btn btn-sm btn-primary px-4">Post Complaint</a>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="dashboard-card p-4 text-center animate__animated animate__fadeIn  glass-card">
                        ...
                        <p class="text-muted mb-3">Share your feedback</p>
                        <a href="Feedback.php" class="btn btn-sm btn-primary px-4">Give Feedback</a>
                    </div>
                </div>
            </div>
            ...
            <div class="row mt-5">
                <div class="col-12">
                    <div class="d-flex justify-content-between align-items-center mb-4 animate__fade In  ">
                        <h4 class="fw-bold text-white">Recommended For You</h4>
                    ...
                    <div class="game-grid">
                        ...
                        <div class="game-card animate__animated animate__fadeIn">
                            ...
                            <div class="game-card-footer">
                                <span class="text-muted">Popular this week</span>
                                 <a href="Viewgame.php" class="btn btn-sm btn-outline-primary">Play now</a>
                            </div>
                        </div>
                        ...
                        <div class="game-card animate__animated animate__fadeIn animate__delay-1s ">
                            ...
                            <div class="game-card-footer">
                                <span class="text-muted">Editor's choice</span>
                                 <a href="Viewgame.php" class="btn btn-sm btn-outline-primary">Play now</a>
                            </div>
                        </div>
                        ...
                        <div class="game-card animate__animated animate__fadeIn animate__delay-2s">
                            ...
                            <div class="game-card-footer">
                                <span class="text-muted">Popular in your region</span>
                                <a href="Viewgame.php" class="btn btn-sm btn-outline-primary">Play now</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12">
                    <div class="dashboard-card p-4 glass-card">
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                <h4 class="fw-bold mb-3">Your Gaming Stats</h4>
                                <p class="text-muted mb-4 opacity-75">Track your gaming performance and achievements</p>
                                <div class="d-flex flex-wrap gap-3">
                                    <div class="stat-card">
                                        <small class="text-primary opacity-85">Weekly Play Time</small>
                                        <h3 class="mb-0 fw-bold mt-2">12h</h3>
                                    ...
                                    <div class="stat-card">
                                        <small class="text-success opacity-85">Achievement Rate</small>
                                    ...
                                    <div class="stat-card">
                                        <small class="text-warning opacity-85">Friends Online</small>
                                        <h3 class="mb-0 fw-bold mt-2">8</h3>
                                        <div class="progress-ring">
                                            <svg width="80" height="80">
                                                <circle stroke="rgba(255,255,255,0.1)" stroke-width="6" fill="transparent" r="35" cx="40" cy="40"/>
