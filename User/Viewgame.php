        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="https://www.ign.com/upcoming/games">New Releases</a>
                    </li>
                </ul>
                <div class="d-flex">
    ...
    <div class="featured-section p-4 p-lg-5">
        ...
        <div class="row align-items-center">
            <div class="col-lg-6 mb-4 mb-lg-0" data-aos="fade-right">
                ...
                <p class="text-muted mb-4">Experience the ultimate cyberpunk adventure with stunning visuals and immersive gameplay that will keep you hooked for hours. <a href="/game-details" class="text-primary">Learn more</a> about the game's features.</p>
                <div class="d-flex flex-wrap">
                    <div class="me-4 mb-3">
                        ...
                        <a href="/reviews" class="small text-muted">Read reviews</a>
                    </div>
                    <div class="me-4 mb-3">
                        <div class="text-primary fw-bold">10M+</div>
                        <div class="text-muted small">Downloads</div>
                        <a href="/top-games" class="small text-muted">See top games</a>
                    </div>
                    <div class="mb-3">
                        <div class="text-primary fw-bold">1.2GB</div>
                        <div class="text-muted small">Size</div>
                        <a href="/system-requirements" class="small text-muted">System requirements</a>
                    </div>
                </div>
                <div class="d-flex mt-4">
                    
                    
                    <a href="trailer.php" class="btn btn-outline-light btn-lg me-3">
                        <i class="fas fa-play-circle me-2"></i> Watch Trailer
                    </a>
                     
                </div>
                <div class="mt-3">
                    <a href="../review.php" class="me-3"><i class="fas fa-gamepad me-1"></i> Similar Games</a>
                    <a href="../categories.php" class="me-3"><i class="fas fa-robot me-1"></i> Cyberpunk Collection</a>
                    <a href="../community.php"><i class="fas fa-comments me-1"></i> Community Forums</a>
                </div>
            </div>
