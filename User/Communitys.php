...
if (isset($_GET["gid"]) && is_numeric($_GET["gid"])) {
    ...
    $checkMember = "SELECT * FROM tbl_member WHERE user_id = '$userId' AND community_id = '$communityId'";
    ...
    if ($memberResult->num_rows > 0) {
        ...
        // Insert new member
        $insQry = "INSERT INTO tbl_member (user_id, community_id, member_status) VALUES ('$userId', '$communityId', 0)";
        if ($Con->query($insQry)) {
            echo "<script>
            Swal.fire({
                icon: 'success',
