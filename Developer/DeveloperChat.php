...
$selCommunity = "SELECT * FROM tbl_community WHERE community_id = ?";
$stmt = $Con->prepare($selCommunity);
...
$memberCheck = "SELECT * FROM tbl_member WHERE developer_id = ? AND community_id = ? AND member_status = 0";
$stmt = $Con->prepare($memberCheck);
$stmt->bind_param("ii", $did, $communityId);
$stmt->execute();
...
<head>
    ...
    <title>Developer Chat in <?php echo htmlspecialchars($row["community_name"]) ?></title>
...
<body>
    ...
    <div class="community-modal" id="communityModal">
        <div class="community-content">
            ...
            <img src="../Assets/Files/User/Community/<?php echo htmlspecialchars($row["community_photo"]) ?>" alt="Community Photo">
    ...
    <div class="chat-container">
        <div class="chat-header">
            <img src="../Assets/Files/User/Community/<?php echo htmlspecialchars($row["community_photo"]) ?>" alt="Community Photo" onclick="openCommunityModal()">
    ...
    <script>
        ...
        function loadMessages() {
            ...
            $.ajax({
                url: `../Assets/AjaxPages/AjaxDeveloperChatLoad.php?id=${communityId}`,
                success: (data) => {
