...
if (isset($_GET['gid']) && isset($_GET['game'])) {
    ...
    if ($Con->query($insQry)) {
        echo "<script>
                ...
                window.location='Viewgamedetails.php?gid=$gid';
              </script>";
        exit();
    } else {
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="Game.php">Upload Game</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="game-actions">
                           <a href="../Assets/Files/Developer/Game/<?php echo $data['game_file']; ?>" 
   download="<?php echo $data['game_file']; ?>"
