...
if(isset($_POST["rating_data"]))
{
	...
	$ins = "INSERT INTO tbl_rating(user_id,rating_value,rating_content,rating_datetime,game_id)VALUES('".$_SESSION['uid']."','".$_POST["rating_data"]."','".$_POST["user_review"]."',NOW(),'".$_POST["game_id"]."')";
...
if(isset($_POST["action"]))
{
  ...
  $query = "
	SELECT * FROM tbl_rating r inner join tbl_user c on r.user_id=c.user_id where r.game_id = '".$_POST["game_id"]."'  ORDER BY r.rating_id DESC
	";
